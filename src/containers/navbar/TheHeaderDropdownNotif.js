    ...
    return (
        ...
        >
            <Dropdown.Toggle className="c-header-nav-link" caret={false}>
                ...
                <Badge shape="pill" color="danger">{itemsCount}</Badge>
            </Dropdown.Toggle>
            <Dropdown.Menu placement="bottom-end" className="pt-0">
                ...
                <Dropdown.Item>
                    ...
                    New client</Dropdown.Item>
                <Dropdown.Item>
                    {/* <CIcon name="cil-speedometer" className="mr-2 text-warning" /> */}
                    Server overloaded</Dropdown.Item>
                <Dropdown.Item
                    header
                    tag="div"
                    color="light"
                ...
                <Dropdown.Item className="d-block">
                    ...
                    <ProgressBar size="xs" color="info" value={25} />
                ...
                <Dropdown.Item className="d-block">
                    ...
                    <ProgressBar size="xs" color="warning" value={70} />
                ...
                <Dropdown.Item className="d-block">
                    ...
                    <ProgressBar size="xs" color="danger" value={90} />
